...
- Replace all occurrences of "SNCTP" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `SNCTP` means the name of the project, while `snctp` is used in file names.
  - Remember to rename the `include/snctp` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
